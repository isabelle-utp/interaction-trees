section \<open> RoboChart Channel Types \<close>

theory RC_Channel_Type
  imports Main Optics.Channel_Type
  keywords "rcchantype" :: "thy_defn" 
       (* and "enumchan" :: "thy_defn" *)
begin

ML \<open>
structure RC_Channel_Type =
struct
