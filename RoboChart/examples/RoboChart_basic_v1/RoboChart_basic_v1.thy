...
definition "ITIDS_stm1_list = [TID_stm1_t1, TID_stm1_t2, TID_stm1_t3]"
...
"int_int_stm1 = 
  set ((enumchan2 reset__stm1_C [TID_stm1_t1,TID_stm1_t2,TID_stm1_t3] [din, dout]) @
       (enumchan3 update__stm1_C [TID_stm1_t1,TID_stm1_t2,TID_stm1_t3] [din, dout] rc.core_int_list) @
       (enumchan1 internal_stm1_C [TID_stm1_t1,TID_stm1_t2,TID_stm1_t3])
)"
...
" tids_stm1_s0 = 
    (filter 
        (\<lambda> s. s \<notin> {NULLTRANSITION_stm1,TID_stm1_t1,TID_stm1_t2,TID_stm1_t3}) 
        ITIDS_stm1_list)"
